...
==============================================
    ...
    ==� [<> AUTHOR   : nobita          ===�
    ==� [<> GITHUB   : Nobita10        ===�
    ==� [<> WHATSAPP : 01314412828     ===�
    ==� [<> POWER BY : \x1b[1;32mnobita\x1b[1;97m            鈹�
    ==================================================================================033[1;92m""")
		print("%s [%s!%s] %sTOOL NAME : %sOLD CLONER"%(G,R,G,Y,G))
		print("%s [%s!%s] %sVERSION   : %s2.0 "%(G,R,G,Y,G))
		print("%s [%s!%s] %sSTATUS    : %sF R E E"%(G,R,G,Y,G)) 
		print("\033[97;1m   =/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=/=")
	...
	def email(self):
		x = 111
		xx = 999
		nam = input("%s [?] TYPE A NAME %s(EX:fahim ", " NOBITA ): "%(Y,G))
		nam = nam.replace(" ", "")
